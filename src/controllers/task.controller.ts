...
export class TaskController {
  ...
  @Put('/archive/:id')
  @ApiOperation({
    summary: 'Toggle task archive status',
    description: 'Archive or unarchive a task.',
  })
  @ApiResponse({
    status: 200,
    description: 'Task archive status toggled successfully.',
  })
  async toggleArchiveTask(
    ...
    try {
      ...
      throw new InternalServerErrorException(
        'Error toggling task archive status',
      );
    }
  }
